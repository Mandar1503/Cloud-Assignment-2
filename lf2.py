...
def receiveMsgFromSqsQueue():
    ...
    queue_url = 'https://sqs.us-east-1.amazonaws.com/099597342107/queue-name'
...
def findRestaurantFromElasticSearch(cuisine):
    ...
    host = 'search-restaurants-ci3lpanwoa4nuuzd4dz22yz7au.us-east-1.es.amazonaws.com'
    index = 'restaurants'
